...
public class ServiciosHasEmpleados {
    ...
    public ServiciosHasEmpleados(int Servicios_codigoServicio, int codigoServicio, int codigoEmpleado, Date fechaEvento, Time horaEvento, String lugarEvento) {
